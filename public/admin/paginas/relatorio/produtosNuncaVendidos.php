    ...
    <div class="container-fluid">
          <div class="card">
            <div class="card-header">
              <h1>Produtos Nunca Vendidos!</h1>
            <form name="form1" action="gerarRelatorio/produtosNaoVendidos.php" target="_blank" method="post" data-parsley-validate>
            <div class="row">
            <div class="col-3">
              ...
              <div class="table-responsive">
                ...
                <table id="datatable1" style="width: 100%;" class="table dataTable no-footer table-hover" role="grid" aria-describedby="datatable1_info">
                  ...
                  <tbody>
                    ...
                    $dados = $carrinhoC->gerarRelatorioProdutoNuncaVendidosAll($mercado_id);
