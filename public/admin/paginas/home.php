    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-logo"><a href="home.php" class="brand-small text-center"> <strong>MA</strong><strong class="text-primary">RS</strong></a></div>
        </div>
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="home.php?op=listas&pg=cliente">Clientes</a></li>
            <li><a href="home.php?op=listas&pg=categoria">Categorias</a></li>
            <li><a href="home.php?op=listas&pg=produto">Produtos</a></li>
            <li><a href="home.php?op=listas&pg=promocao">Promoções</a></li>
            <li><a href="home.php?op=listas&pg=vendidos">Produtos Vendidos</a></li>
            <li><a href="#DropdownRelatorio" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-bar-chart"></i>Relatórios</a>
              ...
              <li><a href="home.php?op=relatorio&pg=produtosMaisVendidos">Produtos Mais Vendidos</a></li>
                <li><a href="home.php?op=relatorio&pg=produtosNuncaVendidos">Produtos não foram vendidos</a></li>
                <li><a href="home.php?op=relatorio&pg=clientesMaisCompraram">Clientes Mais Compraram</a></li>
                <li><a href="home.php?op=relatorio&pg=clientesNuncaCompraram">Clientes Nunca Comprou</a></li>
              </ul>
            </li>
          </ul>
        </div>
