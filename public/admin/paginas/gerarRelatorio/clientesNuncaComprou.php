...
$result = $carrinhoP->gerarRelatorioClientesNuncaComprouAll();
...
class myPDF extends FPDF{
    function header(){
        ...
        $this->Cell(276,10,'Clientes que nunca compraram',0,0,'C');
        $this->Ln();
        $this->SetFont('Times','',12);
    ...
    function headerTable(){
        ...
        $this->Cell(70,5,'NOME',1,0,'C');
        $this->Cell(60,5,'Endereco',1,0,'C');
        $this->Cell(60,5,'E-mail',1,0,'C');
        $this->Cell(60,5,'Celular',1,0,'C');
        $this->Ln();
        ...
        foreach ( $result as $p ){
                ...
                if ( isset ( $p->nome ) ) $this->Cell(70,7,$p->nome,1,0,"C");
                if ( isset ( $p->endereco ) ) $this->Cell(60,7,utf8_decode($p->endereco),1,0,"C");
                if ( isset ( $p->email ) ) $this->Cell(60,7,$p->email,1,0,"C");
                if ( isset ( $p->celular ) ) $this->Cell(60,7,$p->celular,1,0,"C").$this->Ln();
...
$pdf->SetTitle('Clientes que nunca compraram');
