        ...
        <div class="container-fluid">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <?php
                if($_SESSION["sistema"]["tipo"] == "Master") {
                  echo "<a class='btn btn-info' href='home.php?op=listas&pg=promocao'>Promoções Atuais
                  </a>";
                } else {
                  echo "<a class='btn btn-info' href='homeA.php?op=listas&pg=promocao'>Promoções Atuais
                  </a>";
                }
              ?>
              ...
              <div class="table-responsive">
                ...
                <table id="datatable1" style="width: 100%;" class="table dataTable no-footer table-hover" role="grid" aria-describedby="datatable1_info">
                  ...
                  <tbody>
                    ...
                    $dados = $promocaoP->listarPromocaoAdminAntiga($_SESSION["sistema"]["mercado"]);
