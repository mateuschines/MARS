...
<section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Produto</h1>
          </header>
          <div class="card">
            <div class="card-header">
              ...
              <?php
                if($_SESSION["sistema"]["tipo"] == "Master") {
                  echo "<a class='btn btn-success' href='home.php?op=cadastro&pg=produto'>Cadastrar Novo <i class='fa fa-plus'></i>
                  </a>";
                } else {
                  echo "<a class='btn btn-success' href='homeA.php?op=cadastro&pg=produto'>Cadastrar Novo <i class='fa fa-plus'></i>
                  </a>";
                }
              ?>
                    ...
                    foreach ($dados as $key) {
                      ...
                      if($_SESSION["sistema"]["tipo"] == "Master") {
                        echo "<tr>
                              ...
                              <td>$preco</td>
                              <td>
                                <a href='home.php?op=cadastro&pg=produto&id=$key->id' class='btn btn-info'>
                        ...
                        echo "<tr>
                              ...
                              <td>$preco</td>
                              <td>
                                <a href='homeA.php?op=cadastro&pg=produto&id=$key->id' class='btn btn-info'>
                                <i class='fa fa-pencil'></i></a>
