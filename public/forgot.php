...
<body>
  ...
  <!-- Preloader --> 
    <div class="load">
      <img src="images/imagens/load1.gif">
     </div>
     <!--preloader end-->
                ...
                <div class="clearfix contact-form">
                  <div class="col-sm-12">
                    <div class="clearfix card-panel grey lighten-5 cform-wrapper">
                      <form action="recuperaSenha.php" method="post" id="contactForm" novalidate data-parsley-validate>
                      <div class="input-field">
                          <input id="celular" type="text" name="celular" class="validate input-box" required data-parsley-required-message="<script>alert('Preencha o e-mail');</script>"data-mask="(99) 9999-9999?9">
                          <label for="celular" class="input-label">Celular</label>
                        </div>                       
                        <div class="input-field">
                          <input id="email" type="email" name="email" class="validate input-box" required data-parsley-required-message="<script>alert('Preencha o e-mail');</script>">
                          <label for="email" class="input-label">Email</label>
                        </div>
                        <div class="input-field">
                          <input id="" type="text" name="cpf" class="validate input-box" data-parsley-required-message="<script>alert('Preencha a CPF');</script>" data-mask="999.999.999-99">
