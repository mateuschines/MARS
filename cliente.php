            ...
            <div class="nav-inner">
              <nav class="primary-nav">
                <div class="clearfix nav-wrapper">
                  <a href="index.php" class="left brand-logo menu-smooth-scroll" data-section="#home"><img src="images/imagens/Drrnovo.png" alt="">
                  </a>
                  ...
                  <!-- Mini Profile // only visible in Tab and Mobile -->
                    ...
                    <li><!-- Modal Trigger -->
                        <a class="menu-smooth-scroll" data-section="index.php" href="index.php">
                          <i class="fa fa-file-text fa-fw black-text"></i>
